...
| Путь                                                                       |  Тип   | Описание                                                            |
| -------------------------------------------------------------------------- | :----: | ------------------------------------------------------------------- |
| `/`                                                                        |  GET   | Корень проекта, возвращает `index.html`                             |
| `/courses`                                                                 |  GET   | Предоставляет пути к статическим файлам сервера                     |
| `/api/courses/`                                                            |  GET   | Получение информации обо всех загруженных курсах                    |
| `/api/courses/:coursePath`                                                 |  GET   | Получение подробной информации об определённом курсе                |
| `/api/courses/:coursePath/modules/:module/lessons/:lesson`                 |  GET   | Получение информации об определённом уроке                          |
| `/api/courses/:coursePath/modules/:module/lessons/:lesson/tasks/:task`     |  GET   | Получение информации о тесте                                        |
| `/api/courses/:coursePath/modules/:module/lessons/:lesson/mission`         |  GET   | Получение информации о миссии                                       |
| `/api/courses/:coursePath/modules/:module/lessons/:lesson/actions/:action` |  GET   | Получение информации о действии героя                               |
| `/api/courses/:coursePath/tests/heroPhrases/:num`                          |  GET   | Получение информации о реакции героя на `num` попытку решения теста |
| `/api/courses/upload`                                                      |  POST  | Загрузка архива с новым курсом                                      |
| `/api/courses/:coursePath`                                                 | DELETE | Удаление существующего курса                                        |
| `/api/login`                                                               |  POST  | Метод авторизации и получения токена авторизации                    |
| `/api/login/change-login`                                                  |  POST  | Метод смены логина пользователя                                     |
| `/api/login/change-password`                                               |  POST  | Метод смены пароля пользователя                                     |
| `/api/user/stats/:coursename`                                              |  GET   | Получение статистики пользователя по курсу                          |
| `/api/user/stats/:coursename`                                              |  PUT   | Обновление статистики пользователя по курсу                         |
