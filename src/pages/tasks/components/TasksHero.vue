<script setup>
import { heroController } from '../taskData';
import { ref } from 'vue';
...
<template>
    <div class="bubble-wrapper">
        <div class="bubble">
            <span ref="bubbleMessage" class="bubble-message"> {{ heroController.heroPhrase }} </span>
            <span class="bubble-triangle"></span>
            <div ref="bubbleCharacter" class="bubble-character">
                <img :src="heroController.heroImgUrl.value" alt="hero-img">
            </div>
        </div>
    </div>
</template>
